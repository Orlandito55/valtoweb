...
const StatCounter = ({ number, label, index }: { number: string; label: string; index: number }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-20 max-w-7xl mx-auto px-4 text-center flex items-end h-full pb-16 sm:pb-20 md:pb-24">
          <motion.div
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-8 leading-none font-futura-lux">
              <motion.span 
              ...
              >
                ...
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                  <div className="grid grid-cols-1 gap-0">
                    <div className="p-3 lg:p-4 flex flex-col justify-center text-white" style={{ background: 'linear-gradient(135deg, #0047BB 0%, #002677 100%)' }}>
                      <p className="text-base lg:text-lg text-blue-100 leading-relaxed mb-3 font-futura-book text-justify">
...
capacitación empresarial. 
                    ...
                    <div className="p-3 lg:p-4 flex flex-col justify-center bg-white">
                      <h3 className="text-xl lg:text-2xl font-bold mb-2 font-futura-lux" style={{ color: '#0047BB' }}>Nuestro Compromiso</h3>
                      <p className="text-sm lg:text-base leading-relaxed mb-2 font-futura-book text-justify">
...
accionistas e inversionistas de la Empresa.
                      ...
                      <Handshake className="w-8 h-8" style={{ color: '#0047BB' }} />
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <StatCounter key={index} number={stat.number} label={stat.label} index={index} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="mision" className="py-24 px-4 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 px-4 items-stretch">
            {/* Vision Card */}
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              ...
              <div className="relative bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-blue-200 h-full overflow-hidden">
                ...
                <div className="flex items-start gap-4 mb-6 relative z-10">
                  ...
                  <div>
                    ...
                    <div className="h-1 w-20 rounded-full" style={{ background: 'linear-gradient(to right, #0047BB, #002677)' }} />
                  </div>
                </div>
              ...
              <div className="relative bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-blue-200 h-full overflow-hidden">
                ...
                <div className="flex items-start gap-4 mb-6 relative z-10">
                  ...
                  <div>
                    ...
                    <div className="h-1 w-20 rounded-full" style={{ background: 'linear-gradient(to right, #002677, #0047BB)' }} />
                  </div>
                </div>
            ...
            {valores.map((valor, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`relative bg-gradient-to-br ${valor.bgColor} p-8 rounded-2xl border-2 hover:shadow-2xl transition-all duration-300 h-full flex flex-col`} style={{ borderColor: '#E8F0FE' }}>
                    ...
                    <p className="text-gray-600 leading-relaxed font-futura-book text-justify flex-grow">
                      {valor.description}
                    </p>
